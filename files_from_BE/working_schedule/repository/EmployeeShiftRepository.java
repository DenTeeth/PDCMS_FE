...
public interface EmployeeShiftRepository extends JpaRepository<EmployeeShift, String> {
         ...
         * - source = BATCH_JOB or REGISTRATION_JOB (auto-generated by scheduled jobs)
         * - status = SCHEDULED (not yet worked)
         * 
         * Historical data (past shifts) and manual entries are preserved.
         *
         * @param employeeId employee ID
         * @param today current date (shifts before this are preserved)
