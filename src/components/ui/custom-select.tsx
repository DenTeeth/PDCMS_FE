    ...
    return (
      <div className="relative" data-select-wrapper>
        ...
        <div className="relative">
          ...
          {isOpen && (
            <ul
              className="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-lg bg-white py-1 text-base shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm transform opacity-100 scale-100 transition ease-out duration-200"
              role="listbox"
            >
              {options.map((option) => (
                <li
