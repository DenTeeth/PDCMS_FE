                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <motion.div
                            ...
                            className="mb-4"
                        >
                            <span className="inline-block px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-medium backdrop-blur-sm">
                                Introducing Dentia
                            </span>
                        </motion.div>
                        ...
                        >
                            ...
                            <Link
                                href="#services"
                                className="inline-block border-2 border-primary/20 bg-background/50 backdrop-blur-sm text-foreground px-8 py-4 rounded-lg hover:bg-accent/50 transition-all font-medium text-center transform hover:scale-105"
                            >
                                Our Services
                            </Link>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="flex items-center gap-4 bg-background/50 backdrop-blur-sm p-4 rounded-lg inline-flex"
                        >
                    ...
                    >
                        ...
                        <div className="relative overflow-hidden rounded-2xl shadow-2xl backdrop-blur-sm bg-white/10 border border-white/20">
                            <div className="relative aspect-[4/3] p-8">
                                <div className="w-full h-full bg-gradient-to-br from-primary/20 to-secondary/20 rounded-xl" />
                            </div>
                        </div>
                    </motion.div>
                </div>
