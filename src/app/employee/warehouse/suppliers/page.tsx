...
import SupplierFormModal from '@/app/admin/warehouse/components/SupplierFormModal';
import SupplierDetailModal from '@/app/admin/warehouse/components/SupplierDetailModal';
