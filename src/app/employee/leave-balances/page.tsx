        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
          <Card className="w-full max-w-2xl">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="reset-year">Năm áp dụng <span className="text-red-500">*</span></Label>
                  <Input
                    id="reset-year"
                    type="number"
                ...
                <div>
                  <Label htmlFor="reset-allowance">Số ngày cộng mặc định <span className="text-red-500">*</span></Label>
                  <Input
                    id="reset-allowance"
                    type="number"
                    placeholder="VD: 12"
