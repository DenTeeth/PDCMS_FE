        ...
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>Bước {step} trong 6</DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    {step === 1 && (
                        <div className="space-y-4">
                            <div>
                                <Label htmlFor="patientSearch">Tìm bệnh nhân</Label>
                        ...
                        <div className="space-y-4">
                            ...
                            {selectedDate && (
                                <div>
                                    ...
                                    {loading ? (
                                        <div className="text-center py-8 text-gray-500">Đang tải các khung giờ khả dụng...</div>
                    ...
                    {step === 4 && selectedDentist && (
                        <div className="space-y-4">
                            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                <div className="font-medium text-blue-900 mb-2">Nha sĩ được chỉ định</div>
                        ...
                        <div className="space-y-4">
                            <div className="p-4 bg-gray-50 rounded-lg space-y-3">
                                ...
                                <div>
                                    ...
                                    <div className="font-medium">
                                        {format(new Date(selectedDate), 'PPP')} lúc {watch('startTime')}
                                    </div>
                                </div>
                                <div>
                            ...
                            <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg flex items-start gap-2">
                                ...
                                <div className="text-sm text-yellow-800">
                                    Vui lòng kiểm tra kỹ tất cả các chi tiết trước khi xác nhận cuộc hẹn.
                                </div>
                            </div>
                        </div>
                    )}
                        ...
                        <div className="flex gap-2">
                            ...
                            {step < 6 ? (
                                ...
                                <Button type="submit" disabled={loading}>
                                    {loading ? 'Đang tạo...' : 'Xác nhận cuộc hẹn'}
