...
import { dentistAppointments, additionalAppointments } from '@/data/dentist-data';
...
export default function AppointmentSchedulePage() {
  ...
  const getAppointmentsForDate = (date: Date) => {
    ...
    return [...dentistAppointments, ...additionalAppointments].filter(apt => apt.date === dateString);
  };
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Manage your daily appointments and patient schedule
          </p>
        </div>
