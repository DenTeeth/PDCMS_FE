                            ...
                            {[1, 2, 3].map((_, index) => (
                                <tr key={index} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div className="text-sm text-gray-500">Dental Cleaning</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">8 Total</div>
                                        <div className="text-sm text-gray-500">2 Upcoming</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
