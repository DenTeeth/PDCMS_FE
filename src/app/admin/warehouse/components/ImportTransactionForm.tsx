...
export default function ImportTransactionForm({
  ...
  useEffect(() => {
    if (!isOpen) {
      ...
      // setInvoiceNumber removed - auto-generated by BE
  ...
  const mutation = useMutation({
    ...
    onError: (error: any) => {
      ...
      // DUPLICATE_INVOICE error removed - invoice numbers are auto-generated by BE
      if (errorCode === 'BATCH_EXPIRY_CONFLICT') {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // invoiceNumber validation removed - auto-generated by BE
    ...
    const payload: CreateImportTransactionDto = {
      ...
      // invoiceNumber removed - auto-generated by BE
