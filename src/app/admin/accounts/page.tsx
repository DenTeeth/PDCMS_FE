        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-red-50 rounded-xl border border-red-200 shadow-sm p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-semibold text-red-800">Inactive</p>
                <p className="text-2xl font-bold text-red-800">{users.filter(u => u.status === 'inactive').length}</p>
              </div>
            </div>
          </div>
          {/* Doctors */}
          <div className="bg-purple-50 rounded-xl border border-purple-200 shadow-sm p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-semibold text-purple-800">Doctors</p>
                <p className="text-2xl font-bold text-purple-800">{users.filter(u => u.role === 'doctor').length}</p>
              </div>
            </div>
          </div>
        </div>
