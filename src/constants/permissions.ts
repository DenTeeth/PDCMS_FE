...
export const PERMISSION_MAPPING: Record<string, string | null> = {
    ...
    // CREATE/UPDATE/DELETE shifts (Employee Shifts) - BE uses MANAGE_FIXED_REGISTRATIONS (EmployeeShiftController line 196, 229, 252)
    'CREATE_SHIFTS': 'MANAGE_FIXED_REGISTRATIONS', // BE: MANAGE_FIXED_REGISTRATIONS for employee shifts
    'UPDATE_SHIFTS': 'MANAGE_FIXED_REGISTRATIONS', // BE: MANAGE_FIXED_REGISTRATIONS for employee shifts
    'DELETE_SHIFTS': 'MANAGE_FIXED_REGISTRATIONS', // BE: MANAGE_FIXED_REGISTRATIONS for employee shifts
