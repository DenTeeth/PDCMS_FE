...
export enum Permission {
  ...
  // Overtime Request permissions (UPDATED: Backend standardized naming)
  ...
  // @deprecated - Use CREATE_OVERTIME instead
  CREATE_OT = 'CREATE_OVERTIME',
  // @deprecated - Use APPROVE_OVERTIME instead
  APPROVE_OT = 'APPROVE_OVERTIME',
  // @deprecated - Use REJECT_OVERTIME instead
  REJECT_OT = 'REJECT_OVERTIME',
  // @deprecated - Use CANCEL_OVERTIME_OWN instead
  CANCEL_OT_OWN = 'CANCEL_OVERTIME_OWN',
  // @deprecated - Use CANCEL_OVERTIME_PENDING instead
  CANCEL_OT_PENDING = 'CANCEL_OVERTIME_PENDING',

  // Time Off Request permissions (from BE response)
  ...
  // Leave Type Management permissions (UPDATED: Backend consolidated)
  VIEW_LEAVE_TYPE = 'VIEW_LEAVE_TYPE',
  MANAGE_LEAVE_TYPE = 'MANAGE_LEAVE_TYPE', // Covers create/update/delete

  // @deprecated - Use VIEW_LEAVE_TYPE instead
  VIEW_TIME_OFF_TYPE = 'VIEW_LEAVE_TYPE',
  // @deprecated - Use MANAGE_LEAVE_TYPE instead
